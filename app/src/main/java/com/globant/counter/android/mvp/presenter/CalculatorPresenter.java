...
public class CalculatorPresenter {
    ...
    public CalculatorPresenter(CalculatorView view, SumModel sumModel, MultiplicationModel multiplicationModel) {
        this.view = view;
    ...
    public void onSolveOperationPressed(String data){
        if(regexUtil.isSumValid(data)){
            ...
            sumModel.clean();
        } else if(regexUtil.isMultiplicationValid(data)){
            multiplicationModel.solveOperation(regexUtil.cleanData(data));
            view.setResult(data + multiplicationModel.getResult());
