...
public class CalculatorPresenter {
    ...
    public CalculatorPresenter(CalculatorView view, SumModel sumModel, SubtractionModel subtractionModel) {
        this.view = view;
    ...
    public void onSolveOperationPressed(String data){
        if(regexUtil.isSumValid(data)){
            ...
            sumModel.clean();
        } else if(regexUtil.isSubtractionValid(data)){
            subtractionModel.solveOperation(regexUtil.cleanData(data));
            view.setResult(data+ subtractionModel.getResult());
