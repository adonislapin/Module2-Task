...
public class CalculatorPresenter {
    ...
    public CalculatorPresenter(CalculatorView view, SumModel sumModel,DivisionModel divisionModel) {
        this.view = view;
    ...
    public void onSolveOperationPressed(String data){
        if(regexUtil.isSumValid(data)){
            ...
            sumModel.clean();
        } else if(regexUtil.isDivisionValid(data)){
            divisionModel.solveOperation(regexUtil.cleanData(data));
            view.setResult(data + divisionModel.getResult());
            divisionModel.clean();
        }else {
