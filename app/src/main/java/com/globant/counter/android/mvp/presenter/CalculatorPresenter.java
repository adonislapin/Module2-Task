...
public class CalculatorPresenter {
    ...
    public CalculatorPresenter(CalculatorView view, SumModel sumModel, ModuleModel moduleModel) {
        this.view = view;
    ...
    public void onSolveOperationPressed(String data){
        if(regexUtil.isSumValid(data)){
            ...
            sumModel.clean();
        } else if(regexUtil.isModuleValid(data)){
            moduleModel.solveOperation(regexUtil.cleanData(data));
            view.setResult(data + moduleModel.getResult());
            moduleModel.clean();
        } else {
